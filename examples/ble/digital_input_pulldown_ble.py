...
"""
Setup a digital pin for input pulldown and monitor its changes.
"""
...
def digital_in_pulldown(my_board, pin):
    """
    ...
    my_board.set_pin_mode_digital_input_pulldown(pin, the_callback)
...
try:
    ...
    digital_in_pulldown(board, DIGITAL_PIN)
