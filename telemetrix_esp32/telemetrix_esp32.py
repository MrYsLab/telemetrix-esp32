...
class TelemetrixEsp32(threading.Thread):
    """
    This class exposes and implements the telemetrix API for the ESP32.
    ...
    def __init__(self, com_port=None, arduino_instance_id=1,
        ...
        # a dictionary to map pin numbers to PWM channels
        # key is channel number and value is the GPIO pin number
        pwm_channels = {k: None for (k) in range(15) }
